...
import net.tiny.context.ServiceType;

public class ServiceNode extends ObjectKeyValue<String, String> implements Comparable<ServiceNode> {
    ...
    public ServiceNode(final String host, final int port, final String name, final ServiceType type) {
        setValue(KEY_NAME, name);
        setValue(KEY_HOST, host);
        setValue(KEY_PORT, Integer.toString(port));
        setValue(KEY_SECRET, Boolean.FALSE.toString());
        setValue(KEY_TYPE, type.name());
    }

    public ServiceNode(final String host, final int port, final ServiceType type) {
    ...
    public ServiceNode(final int port, final ServiceType type) {
        this(DEFAULT_HOST, port, DEFAULT_NAME, type);
    }

    public ServiceNode(final int port) {
        this(DEFAULT_HOST, port, DEFAULT_NAME, DEFAULT_TYPE);
    }

    public ServiceNode(final String host, final ServiceType type) {
    ...
    public ServiceNode(final ServiceType type) {
    ...
    public final boolean isSecret() {
        return Boolean.getBoolean(getValue(KEY_SECRET));
    }
    ...
    @Override
    public int compareTo(ServiceNode target) {
